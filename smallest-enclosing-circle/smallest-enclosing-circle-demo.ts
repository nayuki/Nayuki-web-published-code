...
let staticRadio: HTMLInputElement = queryInput("#random-static"  );
let movingRadio: HTMLInputElement = queryInput("#random-moving"  );
let manualRadio: HTMLInputElement = queryInput("#manual-position");
