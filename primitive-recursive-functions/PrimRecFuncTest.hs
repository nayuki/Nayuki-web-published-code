...
tests = [
	...
	TestCase PrimRecFunc.odd [0] 0,
	TestCase PrimRecFunc.odd [1] 1,
	TestCase PrimRecFunc.odd [2] 0,
	TestCase PrimRecFunc.odd [3] 1,
	TestCase PrimRecFunc.odd [4] 0,
	TestCase PrimRecFunc.odd [5] 1,
	...
	TestCase PrimRecFunc.log [0,  0] 0,
	TestCase PrimRecFunc.log [0,  1] 1,
	TestCase PrimRecFunc.log [0,  2] 2,
	TestCase PrimRecFunc.log [0,  4] 4,
	TestCase PrimRecFunc.log [0,  7] 7,
	TestCase PrimRecFunc.log [1,  0] 0,
	TestCase PrimRecFunc.log [1,  1] 1,
	TestCase PrimRecFunc.log [1,  2] 2,
	TestCase PrimRecFunc.log [1,  5] 5,
	TestCase PrimRecFunc.log [1,  9] 9,
	TestCase PrimRecFunc.log [2,  0] 0,
	TestCase PrimRecFunc.log [2,  1] 0,
	TestCase PrimRecFunc.log [2,  2] 1,
	TestCase PrimRecFunc.log [2,  3] 1,
	TestCase PrimRecFunc.log [2,  4] 2,
	TestCase PrimRecFunc.log [2,  5] 2,
	TestCase PrimRecFunc.log [2,  6] 2,
	TestCase PrimRecFunc.log [2,  7] 2,
	TestCase PrimRecFunc.log [2,  8] 3,
	TestCase PrimRecFunc.log [2,  9] 3,
	TestCase PrimRecFunc.log [2, 15] 3,
	TestCase PrimRecFunc.log [2, 16] 4,
	TestCase PrimRecFunc.log [2, 17] 4,
	TestCase PrimRecFunc.log [3,  0] 0,
	TestCase PrimRecFunc.log [3,  1] 0,
	TestCase PrimRecFunc.log [3,  2] 0,
	TestCase PrimRecFunc.log [3,  3] 1,
	TestCase PrimRecFunc.log [3,  4] 1,
	TestCase PrimRecFunc.log [3,  8] 1,
	TestCase PrimRecFunc.log [3,  9] 2,
	TestCase PrimRecFunc.log [3, 10] 2,
	TestCase PrimRecFunc.log [3, 26] 2,
	TestCase PrimRecFunc.log [3, 27] 3,
	TestCase PrimRecFunc.log [4,  0] 0,
	TestCase PrimRecFunc.log [4,  1] 0,
	TestCase PrimRecFunc.log [4,  2] 0,
	TestCase PrimRecFunc.log [4,  3] 0,
	TestCase PrimRecFunc.log [4,  4] 1,
	TestCase PrimRecFunc.log [4,  5] 1,
	TestCase PrimRecFunc.log [4,  8] 1,
	TestCase PrimRecFunc.log [4, 15] 1,
	TestCase PrimRecFunc.log [4, 16] 2,
	...
	TestCase PrimRecFunc.divisiblecount [ 0, 0] 0,
	TestCase PrimRecFunc.divisiblecount [ 1, 0] 0,
	TestCase PrimRecFunc.divisiblecount [ 2, 0] 0,
	TestCase PrimRecFunc.divisiblecount [ 4, 0] 0,
	TestCase PrimRecFunc.divisiblecount [ 7, 0] 0,
	TestCase PrimRecFunc.divisiblecount [ 0, 1] 0,
	TestCase PrimRecFunc.divisiblecount [ 1, 1] 1,
	TestCase PrimRecFunc.divisiblecount [ 2, 1] 2,
	TestCase PrimRecFunc.divisiblecount [ 5, 1] 5,
	TestCase PrimRecFunc.divisiblecount [ 9, 1] 9,
	TestCase PrimRecFunc.divisiblecount [ 0, 2] 0,
	TestCase PrimRecFunc.divisiblecount [ 1, 2] 0,
	TestCase PrimRecFunc.divisiblecount [ 2, 2] 1,
	TestCase PrimRecFunc.divisiblecount [ 3, 2] 0,
	TestCase PrimRecFunc.divisiblecount [ 4, 2] 2,
	TestCase PrimRecFunc.divisiblecount [ 5, 2] 0,
	TestCase PrimRecFunc.divisiblecount [ 6, 2] 1,
	TestCase PrimRecFunc.divisiblecount [ 7, 2] 0,
	TestCase PrimRecFunc.divisiblecount [ 8, 2] 3,
	TestCase PrimRecFunc.divisiblecount [ 9, 2] 0,
	TestCase PrimRecFunc.divisiblecount [10, 2] 1,
	TestCase PrimRecFunc.divisiblecount [ 0, 3] 0,
	TestCase PrimRecFunc.divisiblecount [ 1, 3] 0,
	TestCase PrimRecFunc.divisiblecount [ 2, 3] 0,
	TestCase PrimRecFunc.divisiblecount [ 3, 3] 1,
	TestCase PrimRecFunc.divisiblecount [ 4, 3] 0,
	TestCase PrimRecFunc.divisiblecount [ 5, 3] 0,
	TestCase PrimRecFunc.divisiblecount [ 6, 3] 1,
	TestCase PrimRecFunc.divisiblecount [ 7, 3] 0,
	TestCase PrimRecFunc.divisiblecount [ 8, 3] 0,
	TestCase PrimRecFunc.divisiblecount [ 9, 3] 2,
	TestCase PrimRecFunc.divisiblecount [10, 3] 0,
	TestCase PrimRecFunc.divisiblecount [ 0, 4] 0,
	TestCase PrimRecFunc.divisiblecount [ 3, 4] 0,
	TestCase PrimRecFunc.divisiblecount [ 4, 4] 1,
	TestCase PrimRecFunc.divisiblecount [ 5, 4] 0,
	TestCase PrimRecFunc.divisiblecount [ 8, 4] 1,
	TestCase PrimRecFunc.divisiblecount [16, 4] 2,
	...
	TestCase PrimRecFunc.fibonacci [0] 0,
	TestCase PrimRecFunc.fibonacci [1] 1,
	TestCase PrimRecFunc.fibonacci [2] 1,
	TestCase PrimRecFunc.fibonacci [3] 2]
