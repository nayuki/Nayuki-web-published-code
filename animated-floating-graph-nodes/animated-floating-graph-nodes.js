...
function initialize() {
    ...
    graph.initSvgGraph(document.querySelector("article svg"));
...
var Graph = /** @class */ (function () {
    ...
    Graph.prototype.initGraph = function (relWidth, relHeight) {
...
var SvgGraph = /** @class */ (function (_super) {
    ...
    SvgGraph.prototype.initSvgGraph = function (svg) {
        this.svgElem = svg;
        var br = svg.getBoundingClientRect();
        this.initGraph(br.width / Math.max(br.width, br.height), br.height / Math.max(br.width, br.height));
